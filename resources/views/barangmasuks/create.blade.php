...
<div class="table-responsive mt-5">
    <h3 class="text-center"> <b> Create Barang Masuk </b></h3>
    @if($errors->any())
    ...
    @endif
    <form method="POST" action="{{ route('barangmasuks.store') }}">
        {{ csrf_field() }}
        <div class="container mt-3">
            <div class="row">
                ...
                <div class="row justify-content-end mt-2">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('barangmasuks.index')}}" class="btn btn-secondary"> Back </a>
    </form>
</div>
</form>
</div>
